...
local function register_storage_initialize(_, _, images, _, extra_data)
  ...
  for _, img in pairs(images) do
    ...
    elseif extension ~= "jpg" and extension ~= "png" and extension ~= "tif" and extension ~= "webp" then
      ...
      msgout(gettext.ggettest("dtMediaWiki", ("dtMediaWiki.register_storage_initialize warning: using copy mode from an unsupported image format is known to cause a crash.")))
