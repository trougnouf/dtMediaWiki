...
dt.preferences.register(
  ...
  "desc_templates",
  "string",
  "Commons: Templates to be placed in Description",
...
function string:split(sep) -- helper from http://lua-users.org/wiki/SplitJoin, doesn't work with local (?)
...
local function get_intl_descriptions(image, discarded_tags)
  desc_templates = dt.preferences.read(preferences_prefix, "desc_templates", "string"):split()
  intl_descriptions = ""
